...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-3 fv-row mt-3">
            ...
            <option   value="0" {{$sallonappionment->progress_status == 0 ? 'selected':''}} >Upcoming</option>
            <option   value="1" {{$sallonappionment->progress_status == 1 ? 'selected':''}} >Completed</option>
            <option   value="2" {{$sallonappionment->progress_status == 2 ? 'selected':''}} >Canceled</option>
            </select>
        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\SallonAppionmentRequest', 'form') !!}
