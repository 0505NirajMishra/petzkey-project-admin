...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.list', [
            'name' => trans_choice('content.petdetail', 2),
        ]),
        'breadcrumbs' => Breadcrumbs::render('admin.petdetails.index'),
        'filter' => false,
        'create_btn' => [
            'status' => true,
            'route' => route('admin.petdetails.create'),
            'name' => __('messages.create', [
                'name' => trans_choice('content.petdetail', 1),
            ]),
        ],
        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    @include('admin.petdetail.petdetails_table')
                    <!--end::Table-->
                </div>
                <!--end::Card body-->
            </div>
