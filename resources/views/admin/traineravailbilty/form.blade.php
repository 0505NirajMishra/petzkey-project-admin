...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
            ...
            <!-- {!! Form::text('avail_days', null, ['min' => 2, 'max' => 6, 'value' => 2, 'class' => 'form-control form-control-lg form-control-solid', 'placeholder' => trans_choice('content.avail_days', 1)]) !!} -->
        </div>
    </div>  
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\TrainerAvaRequest', 'form') !!}
@endpush
