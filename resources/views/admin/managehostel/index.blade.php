...
@section('admin_filter_form')
    {!! Form::open(['route' => 'admin.categorys.download', 'method' => 'POST', 'id' => 'filter_data', 'class' => 'form mb-15']) !!}
    <!--begin::Card body-->
    <div class="card-body">
        <!--begin::Input group-->
        <div class="row mb-6">
            <!--begin::Label-->
            <label
                class="col-lg-4 col-form-label required fw-bold fs-6">{{ trans_choice('content.categorys.cat_name', 1) }}</label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                {!! Form::text('name', null, ['placeholder' => __('content.categorys.cat_name'), 'value' => 'Max', 'class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0 search_input']) !!}
            </div>
            <!--end::Col-->
...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.list', [
            'name' => trans_choice('content.managehostel', 2),
        ]),
        'breadcrumbs' => Breadcrumbs::render('admin.managehostels.index'),
        'filter' => false,
        'create_btn' => [
            'status' => true,
            'route' => route('admin.managehostels.create'),
            'name' => __('messages.create', [
                'name' => trans_choice('content.managehostel',1),
            ]),
        ],
        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    @include('admin.managehostel.manageservice_table')
                    <!--end::Table-->
                </div>
                <!--end::Card body-->
            </div>
