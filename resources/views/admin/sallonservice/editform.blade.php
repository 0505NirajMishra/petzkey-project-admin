...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-4 fv-row">
        @if($sallonservice->sallon_servc_id)
            <input type="file"  class="form-control form-control-lg form-control-solid" name="sallon_servc_img" accept=".png, .jpg, .jpeg">
            <img src="{{ url('/') }}/sallon/image/{{$sallonservice->sallon_servc_img}}" height="50px;" width="50px;">
        @else
            <input type="file" class="form-control form-control-lg form-control-solid" name="sallon_servc_img" accept=".png, .jpg, .jpeg">
        @endif
        </div>
