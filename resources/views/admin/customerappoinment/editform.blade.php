...
<div class="card-body">
    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-3 fv-row mt-3">
            ...
            <option   value="0" {{$customer->progress_status == 0 ? 'selected':''}} >Upcoming</option>
            <option   value="1" {{$customer->progress_status == 1 ? 'selected':''}} >Completed</option>
            <option   value="2" {{$customer->progress_status == 2 ? 'selected':''}} >Canceled</option>
            </select>
        </div>
