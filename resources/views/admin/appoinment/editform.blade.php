    ...
    <div class="row mb-6">
        ...
        <div class="col-lg-3 fv-row mt-3">
            <select class="form-control form-control-solid" name="progress_status">
              ...
              <option value="0" {{$appoinment->progress_status==0 ?'selected':''}} >Upcoming</option>
              <option value="1" {{$appoinment->progress_status==1 ?'selected':''}} >Completed</option>
              <option value="2" {{$appoinment->progress_status==2 ?'selected':''}} >Canceled</option>
            </select>
        </div>
