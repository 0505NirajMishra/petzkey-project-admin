...
{{-- @section('admin_filter_form')
    {!! Form::open(['route' => 'admin.contactus.download', 'method' => 'POST', 'id' => 'filter_data', 'class' => 'form mb-15']) !!}
    <!--begin::Card body-->
    <div class="card-body">
        <!--begin::Input group-->
        <div class="row mb-6">
            <!--begin::Label-->
            <label
                class="col-lg-4 col-form-label required fw-bold fs-6">{{ trans_choice('content.contactus.name', 1) }}</label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                {!! Form::text('name', null, ['placeholder' => __('content.contactus.name'), 'value' => 'Max', 'class' => 'form-control form-control-lg form-control-solid mb-3 mb-lg-0 search_input']) !!}
            </div>
            <!--end::Col-->
        ...
        <div class="row mb-6">
            ...
            <label class="col-lg-4 col-form-label fw-bold fs-6">
                <span class="required">{{ trans_choice('content.contactus.id', 1) }}</span>
            </label>
            <!--end::Label-->
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.list', [
            'name' => trans_choice('content.contactus', 2),
        ]),
    ...
    @include('admin.layouts.components.datatable_header', [
        'data' => [
            ...
            ['classname' => 'min-w-125px', 'title' => trans_choice('content.user_name_title', 1)],
            ['classname' => 'min-w-125px', 'title' => trans_choice('content.phone_title', 1)],
            ['classname' => 'min-w-125px', 'title' => trans_choice('content.messages_title', 1)],
...
@push('scripts')
    <script>
            ...
            oTable = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.contactus_id = $('input[name=contactus_id]').val();
                ...
                columns: [{
                 ...
                 
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var edit_url = `{{ url('/') }}/admin/contactus/` + row['id'] +
                                `/edit/?tab=edit`;
        ...
        $(document).on('click', '.clsdelete', function() {
            ...
            var url = `{{ url('/') }}/admin/contactus/` + id;
        ...
        $(document).on('click', '.clsstatus', function() {
            ...
            var url = `{{ url('/') }}/admin/contactus/status/` + id + `/` + status;
