...
@section('content')
    ...
    [
        'title' => __('messages.create', ['name' => trans_choice('content.promocode', 1)]),
        'breadcrumbs' => Breadcrumbs::render('admin.promocodes.create'),
    ])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div class="flex-lg-row-fluid me-0 me-lg-20">
                            ...
                            <!--begin::Form-->
                            {!! Form::open(['route' => 'admin.promocodes.store', 'method' => 'POST', 'class' => 'form', 'enctype' => 'multipart/form-data']) !!}
