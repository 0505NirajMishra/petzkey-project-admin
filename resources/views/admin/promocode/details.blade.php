...
@section('content')
    @include('admin.layouts.components.header', [
        'title' => __('messages.edit', ['name' => trans_choice('content.promocode', 1)]),
        'breadcrumbs' => Breadcrumbs::render('admin.promocodes.show'),
    ])
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="fs-5 text-gray-600">{{ $promocode->total_player }}</div>
                            </div>
                            <div class="col-md-4 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.room_no_title', 1) }}
                                </div>
                                <div class="fs-5 text-gray-600">{{ $promocode->room_no }}</div>
                            </div>
                            <div class="col-md-4 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.entry_fee_title', 1) }}</div>
                                <div class="fs-5 text-gray-600">{{ $promocode->entry_fee }}</div>
                            </div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="row mb-5">
                            <div class="col-md-4 fv-row">
                                ...
                                <div class="fs-5 text-gray-600">{{ $promocode->prize }}</div>
                            </div>
                            <div class="col-md-4 fv-row">
                                <div class="fs-5 fw-bold mb-2">{{ trans_choice('content.start_time_title', 1) }}</div>
                                <div class="fs-5 text-gray-600">{{ $promocode->start_time }}</div>
                            </div>
                            <div class="col-md-4 fv-row">
